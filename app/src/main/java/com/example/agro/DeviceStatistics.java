...
public class DeviceStatistics extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void initializeFactors() {
        factorsList= new String[]{"Temperature", "Humidity", "Smoke Sensor", "Relay Status", "Falme Status","Soil Moisture"};
                            ...
                            if(start.before(simpleDateFormat.parse(simpleDateFormat.format(new Date(statistic.getDate())))) && end.after(simpleDateFormat.parse(simpleDateFormat.format(new Date(statistic.getDate()))))){
                                ...
                                switch (selectedFactor){
                                    ...
                                    case 3:recordValue=Float.parseFloat(statistic.getGss()+"");
                                        break;
                                    case 4:recordValue=Float.parseFloat(statistic.getRs()+"");
                                        break;
                                    case 5:recordValue=Float.parseFloat(statistic.getFs()+"");
                                        break;
                                    case 6:recordValue=Float.parseFloat(statistic.getSms()+"");
                                        break;
